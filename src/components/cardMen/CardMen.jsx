  ...
  return (
    ...
    992: { slidesPerView: 3 },    // desktop/laptop
        ...
        >
          ...
          <SwiperSlide>
            <div className="card">
              <img src="/images/men-01.jpg" className="card-img-top" alt="..." />
          ...
          <SwiperSlide>
            <div className="card">
              <img src="/images/men-02.jpg" className="card-img-top" alt="..." />
              <div className="card-body">
          ...
          <SwiperSlide>
            <div className="card">
              <img src="/images/men-03.jpg" className="card-img-top" alt="..." />
              <div className="card-body">
