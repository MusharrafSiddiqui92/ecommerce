  ...
  return (
    <>
      <div className="container mt-5">
        <h1 style={{ fontWeight: 'bold' }}>Kid's Latest</h1>
    ...
    992: { slidesPerView: 3 },    // desktop/laptop
        ...
        >
          ...
          <SwiperSlide>
            <div className="card">
              <img src="/images/kid-01.jpg" className="card-img-top" alt="..." />
          ...
          <SwiperSlide>
            <div className="card">
              <img src="/images/kid-02.jpg" className="card-img-top" alt="..." />
              <div className="card-body">
          ...
          <SwiperSlide>
            <div className="card">
              <img src="/images/kid-03.jpg" className="card-img-top" alt="..." />
              <div className="card-body">
